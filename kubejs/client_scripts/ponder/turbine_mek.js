...
Ponder.registry((allthemods) => {
	...
	.scene('turbine_mek', Text.translate('kubejs.ponder.turbine_mek.header'), 'kubejs:turbine_mek',
	...
	(scene, util) => {
			...
			scene.text(60, Text.translate('kubejs.ponder.turbine_mek.text_1'), [0, 4.5, 4.5]).placeNearTarget().attachKeyFrame();
			scene.idle(65);
			
			scene.text(60, Text.translate('kubejs.ponder.turbine_mek.text_2'), [0, 4.5, 4.5]).placeNearTarget().attachKeyFrame();
			scene.idle(65);
			
			scene.text(60, Text.translate('kubejs.ponder.turbine_mek.text_3'), [0, 2.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(65);
			
			scene.text(60, Text.translate('kubejs.ponder.turbine_mek.text_4'), [0, 1.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(65);
			...
			scene.text(80, Text.translate('kubejs.ponder.turbine_mek.text_5'), [2, 3.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(85);
			...
			scene.text(80, Text.translate('kubejs.ponder.turbine_mek.text_6'), [2, 4.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(85);
			...
			scene.text(80, Text.translate('kubejs.ponder.turbine_mek.text_7'), [1, 4.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(85);
			...
			scene.text(120, Text.translate('kubejs.ponder.turbine_mek.text_8'), [0, 4.5, 3.5]).placeNearTarget().attachKeyFrame();
			scene.idle(125);
			...
			scene.text(60, Text.translate('kubejs.ponder.turbine_mek.text_9'), [2, 5.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(65);
			...
			scene.text(100, Text.translate('kubejs.ponder.turbine_mek.text_10'), [2, 5.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(105);
			...
			scene.text(120, Text.translate('kubejs.ponder.turbine_mek.text_11'), [1, 5.5, 1.5]).placeNearTarget().attachKeyFrame();
			scene.idle(130);
			...
			scene.text(80, Text.translate('kubejs.ponder.turbine_mek.text_12'), [2.5, 6.5, 2.5]).placeNearTarget().attachKeyFrame();
			scene.idle(85);
