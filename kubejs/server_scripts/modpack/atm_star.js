...
ServerEvents.recipes((allthemods) => {
  ...
  allthemods
    ...
    .id("allthetweaks:allthetweaks/atm_star_rotated");
  ...
  allthemods
    ...
    .id("allthetweaks:allthetweaks/patrick_star_rotated");
  ...
  allthemods
    ...
    .id("allthetweaks:allthetweaks/atm_star_from_shard_rotated");
});
